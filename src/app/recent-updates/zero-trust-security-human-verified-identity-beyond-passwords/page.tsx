...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    images: [
      "https://ivalt.com/press-release/images/ivalt-openvpn-webinar.png",
    ],
  },
  other: {
    ...
    <main className="max-w-7xl px-6 py-10 bg-white mx-6 shadow-sm md:mx-auto">
      <article className="leading-relaxed">
        ...
        <p className="my-6 mt-12 text-justify">
          Deepfakes and AI-driven impersonation are breaking traditional trust
          models—and credentials alone are no longer enough. iVALT is excited to
          join{" "}
          <a
        ...
        <p className="mb-6 text-justify">
          <em>
            <span className="text-navy-primary font-bold">→</span> Real Humans
            Only: How to Deliver Human-Verified Zero Trust for Your Organization
          </em>
        </p>
        <p className="mb-6 text-justify">
          In this session,{" "} 
          ...
          will discuss how organizations can move beyond passwords and tokens to
          ensure that only verified humans can access networks and trigger
          sensitive actions, even in the age of AI deepfakes.
        </p>

        <ul className="list-disc pl-6 mb-6 space-y-3">
          <li className="text-justify text-gray-800">Learn how human-bound, passwordless identity strengthens Zero Trust</li>
          <li className="text-justify text-gray-800">Understand the risks AI impersonation introduces to remote access</li>
          <li className="text-justify text-gray-800">See how real-time human verification works in practice</li>
        </ul>
        ...
        <div className="mb-8 p-6 bg-gradient-to-r from-teal-primary/10 to-navy-primary/10 rounded-xl border border-teal-primary/20">
          ...
          <p className="text-gray-700 mb-4">
            Join us for this exclusive webinar and learn how to protect your
            organization from AI-driven impersonation threats.
          </p>
          <a
