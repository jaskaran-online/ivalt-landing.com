          ...
          <FadeInOnScroll>
            <div className="bg-white rounded-xl p-8 py-10 border-none shadow-sm">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-2xl font-bold text-teal-primary">Platform Extensibility</h3>
              </div>
              <p className="text-gray-700 text-lg mb-6">
                iVALT&apos;s platform is extensible beyond the initial three applications—designed
                for <strong>future-proof identity validation</strong> across emerging AI, IoT, and
              ...
              <div className="bg-teal-primary/10 p-6 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-teal-primary">Fast Integration</p>
              ...
              {futureApplications.map((app, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-gray-700 transition-all duration-300">{app.text}</p>
                  </div>
                </div>
              ))}
            </div>
