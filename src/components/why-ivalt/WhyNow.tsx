const WhyNow = () => {
  return (
    <div className="text-center py-16 px-4 bg-white">
      <h2 className="text-4xl md:text-5xl font-bold text-[#2A3F6C] mb-6">Why Now?</h2>
      <p className="mx-auto mt-4 max-w-3xl text-xl font-bold italic text-teal-primary sm:text-2xl my-12">
        ...
        <div className="flex-1 mx-auto md:max-w-md bg-white border-2 border-gray-300 rounded-lg p-6 ">
          ...
          <ul className="text-left text-gray-700 space-y-2 mb-4">
            <li className="flex items-start">
              ...
              <span>
                80–90% of breaches start with <b>stolen credentials</b>
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-[#2A3F6C] mr-2">•</span>
            ...
            <li className="flex items-start">
              <span className="text-[#2A3F6C] mr-2">•</span>
              <span>
                SSO and MFA still rely on <b>credentials that can be stolen or impersonated</b>{' '}
              </span>
            </li>
          </ul>
